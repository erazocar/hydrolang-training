...
const config = {
  ...
  baseUrl: 'tutorials/hydrolang/build/index.html',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'UIHI Lab', // Usually your GitHub org/user name.
  projectName: 'HydroLang', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/uihilab/HydroLang',
            label: 'GitHub',
            position: 'right',
          },
        ],
